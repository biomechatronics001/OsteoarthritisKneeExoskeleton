...
int SaveAssistanceProfileParameters(const char* fileName)
{
  ...
  for (int i = 0; i < cic.sineAssistanceFlexionProfileCounter; i++)
  {
    double sineAssistanceMagnitude = cic.sineAssistanceFlexionParameterList[i][0];
    int sineAssistanceShift = (int)cic.sineAssistanceFlexionParameterList[i][1];
    int sineAssistanceDuration = (int)cic.sineAssistanceFlexionParameterList[i][2];
    double sineAssistanceSaturation = cic.sineAssistanceFlexionParameterList[i][3];
  ...
  for (int i = 0; i < cic.sineAssistanceExtensionProfileCounter; i++)
  {
    double sineAssistanceMagnitude = cic.sineAssistanceExtensionParameterList[i][0];
    int sineAssistanceShift = (int)cic.sineAssistanceExtensionParameterList[i][1];
    int sineAssistanceDuration = (int)cic.sineAssistanceExtensionParameterList[i][2];
    double sineAssistanceSaturation = cic.sineAssistanceExtensionParameterList[i][3];
...
void logData3()
{
  ...
  rb.write(" ");
  rb.print(cic.GP_IMU_L); // estimated gait phase of left leg [0-100, 0 = heel strike, 100 = toe off]
  rb.write(" ");
  rb.print(cic.GP_IMU_R); // estimated gait phase of right leg [0-100, 0 = heel strike, 100 = toe off]
  rb.write(" ");
